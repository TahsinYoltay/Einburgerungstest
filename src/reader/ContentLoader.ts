...
/**
 * Loads HTML content for a specific chapter
 */
export async function loadChapterContent(chapterId: string): Promise<string | null> {
  try {
    ...
    // Use the detailed content we created
    const content = getDefaultContent(chapterId);
    console.log(`Successfully loaded content for ${chapterId}`);
    return content;
  ...
  switch (chapterId) {
    ...
    case '3':
      return `
        ...
        <div class="highlight-box">
            <div class="image-placeholder">
                [A helmet from the time of the Anglo-Saxons and Vikings]
            </div>
        ...
        <div class="highlight-box">
            <div class="image-placeholder">
                [Part of the Bayeux Tapestry – the linen cloth is nearly 70 metres (230 feet) long and is embroidered with coloured wool]
            </div>
        ...
        <p>The queen of Scotland, Mary Stuart (often now called 'Mary, Queen of Scots') was a Catholic. She was only a week old when her father died and she became queen. Much of her childhood was spent in France. When she returned to Scotland, she was the centre of a power struggle between different groups. When her husband was murdered, Mary was suspected of involvement and fled to England. She gave her throne to her Protestant son, James VI of Scotland. Mary was Elizabeth I's cousin and hoped that Elizabeth might help her, but Elizabeth suspected Mary of wanting to take over the English throne, and kept her a prisoner for 20 years. Mary was eventually executed, accused of plotting against Elizabeth I.</p>
    ...
    case '4':
      return `
        ...
        <div class="image-placeholder">
            [Westminster Abbey - coronation church since 1066 and final resting place of many monarchs]
        </div>
        ...
        <div class="image-placeholder">
            [Unveiled in 1920, the Cenotaph is the centrepiece to the Remembrance Day service]
        </div>
